...
export interface DoubleSigningSlasher extends Contract {
    ...
    methods: {
        ...
        initialize(registryAddress: string, _penalty: number | string, _reward: number | string): TransactionObject<void>;
        checkForDoubleSigning(signer: string, index: number | string, headerA: string | number[], headerB: string | number[]): TransactionObject<string>;
        slash(signer: string, index: number | string, headerA: string | number[], headerB: string | number[], groupMembershipHistoryIndex: number | string, validatorElectionLessers: string[], validatorElectionGreaters: string[], validatorElectionIndices: (number | string)[], groupElectionLessers: string[], groupElectionGreaters: string[], groupElectionIndices: (number | string)[]): TransactionObject<void>;
    };
    events: {
