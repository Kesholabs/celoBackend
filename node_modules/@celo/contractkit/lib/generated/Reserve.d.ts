...
export interface Reserve extends Contract {
    ...
    methods: {
        ...
        initialize(registryAddress: string, _tobinTaxStalenessThreshold: number | string, _spendingRatio: number | string, _frozenGold: number | string, _frozenDays: number | string, _assetAllocationSymbols: (string | number[])[], _assetAllocationWeights: (number | string)[]): TransactionObject<void>;
